...
from SENPAIMUSIC.utils.Senpai_ban import admin_filter
...
import asyncio
import time
from SENPAIMUSIC.utils.database import add_served_chat
from pyrogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton
from SENPAIMUSIC.utils.database import get_assistant
import asyncio
from SENPAIMUSIC.misc import SUDOERS
from SENPAIMUSIC.mongo.afkdb import PROCESS
from pyrogram import Client, filters
...
from SENPAIMUSIC.utils.database import get_assistant, is_active_chat
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("SENPAIMUSIC/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((500, 500))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('SENPAIMUSIC/assets/font.ttf', size=60)
    welcome_font = ImageFont.truetype('SENPAIMUSIC/assets/font.ttf', size=60)
...
async def greet_new_member(_, member: ChatMemberUpdated):
    ...
    if member.new_chat_member and not member.old_chat_member and member.new_chat_member.status != "kicked":
        ...
        try:
            ...
            pic = "SENPAIMUSIC/assets/upic.png"
