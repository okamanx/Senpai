...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("SENPAIMUSIC/assets/assets/font2.ttf", 32)
        regular_font = ImageFont.truetype("SENPAIMUSIC/assets/assets/font.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "SENPAIMUSIC/assets/assets/play_icons.png"
